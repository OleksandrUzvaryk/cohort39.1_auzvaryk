...
public class DemoCarSortProducer {


    public static void main(String[] args) {

        TreeSet<Car> myGarage = new TreeSet<>();
        Car car1 = new Car("Toyota", "Corola", 18000,false);
        Car car8 = new Car("Toyota", "Corola", 18000,false);
        Car car9 = new Car("Toyota", "Corola", 18000,true);
       ...
       // Car car7 = new Car(null, "Maccan", 63000,false);
        Car car10 = new Car("Volvo-40025", "C30", 11000,false);
        Car car11 = new Car("Volvo-7", "C30", 11000,false);
